...
public class AuthController {
	...
	public ResponseEntity<?> validateEmail(@RequestBody @Valid ChangePasswordDto changePasswordDto) {
	...
	public ResponseEntity<?> verifyOtp(@RequestBody @Valid AuthRequestOtpDto requestOTP) {
		String str;
	...
	public ResponseEntity<?> forgotPassword(@RequestBody @Valid ChangePasswordDto changePasswordDto) {
	...
	public ResponseEntity<?> changeForgottenPassword(@RequestBody @Valid ChangePasswordDto changePasswordDto) {
