...
public class VendorController {
	...
	@PostMapping
	public ResponseEntity<?> createVendor(@RequestBody @Valid VendorDto vendor){
	...
	public ResponseEntity<?> changeVendorAvailablibility(@RequestBody @Valid VendorDto vendor){
		return new ResponseEntity<>(vendorService.changeAvailability(vendor), HttpStatus.OK) ;
	}
	
	@PatchMapping("/status/block")
	public ResponseEntity<?> changeBlockingStatus(@RequestBody @Valid VendorDto vendor){
